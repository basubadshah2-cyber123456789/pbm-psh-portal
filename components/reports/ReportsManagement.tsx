...
export function ReportsManagement() {
  ...
  const reportOptions = [
    ...
    { id: 'DUTIES', name: '4. Duty Assignment Report', icon: ClipboardList, desc: 'Assigned duties, bilingual names, shifts, status, and completion times' },
    { id: 'HOSTEL', name: '4. Hostel Occupancy & Beds', icon: Building2, desc: '100 beds capacity audit across Block A and Junior Block B' },
