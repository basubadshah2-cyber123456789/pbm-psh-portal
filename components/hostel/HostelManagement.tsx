    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
          ...
          <div className="text-2xl font-extrabold text-blue-800 mt-1">{buildings.reduce((total, building) => total + building.rooms.length, 0)} Rooms</div>
          <div className="text-[11px] text-blue-600 mt-0.5">25 Children per Floor Capacity</div>
        </div>
      </div>
