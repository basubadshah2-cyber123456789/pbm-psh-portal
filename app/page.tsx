          ...
          <div className="max-w-3xl mx-auto my-8 bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-10 text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 mt-1">
                The complete 14-section Pakistan Sweet Home child profile and official dossier have been created.
              </p>
            </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 sm:p-8 shadow-xs">
            <div className="flex flex-wrap items-center justify-between gap-3 mb-6 border-b border-slate-100 pb-4">
              <div className="flex items-center gap-2 text-slate-800 font-bold text-base sm:text-lg">
                ...
                <span>• Child Admission Form (14 Sections)</span>
              </div>
            </div>

            {/* The 14-Section Add PSH Form */}
            <AddPSHForm
          ...
          <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 z-50 overflow-y-auto">
            <div className="bg-white rounded-2xl max-w-4xl w-full p-6 sm:p-8 shadow-2xl border border-slate-200 my-auto max-h-[92vh] overflow-y-auto">
              ...
              <div className="flex justify-between items-center pb-4 border-b border-slate-200 no-print">
                <div>
                  ...
                  <span className="inline-block mt-0.5 px-2.5 py-0.5 rounded-full text-[10px] font-extrabold bg-emerald-100 text-[#0D5C3A] border border-emerald-300">
                    Category: {psh?.category?.type || 'Orphan'} {psh?.category?.replacedRegistrationNo ? `(Replaced: ${psh.category.replacedRegistrationNo})` : ''}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <button
              ...
              <div className="pt-6 space-y-5 text-slate-900">
                ...
                <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-3">
                  <span className="text-[11px] font-bold text-[#0D5C3A] uppercase tracking-wider block border-b border-slate-100 pb-2">3. HEALTH INFO</span>
                ...
                {/* Section 4 & 5: Parents Info */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* Father Info */}
                  <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-2 text-xs">
                    <span className="text-[11px] font-bold text-[#0D5C3A] uppercase tracking-wider block border-b border-slate-100 pb-1.5">4. FATHER INFO</span>
                  ...
                  {/* Mother Info */}
                  <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-2 text-xs">
                    <span className="text-[11px] font-bold text-[#0D5C3A] uppercase tracking-wider block border-b border-slate-100 pb-1.5">5. MOTHER INFO</span>
                ...
                {/* Section 6: Guardian Info */}
                <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-2 text-xs">
                  <span className="text-[11px] font-bold text-[#0D5C3A] uppercase tracking-wider block border-b border-slate-100 pb-1.5">6. GUARDIAN INFO</span>
                ...
                {/* Section 7: Meeting Persons */}
                {psh?.meetingPersons && psh.meetingPersons.length > 0 && (
                  <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-2 text-xs">
                    <span className="text-[11px] font-bold text-[#0D5C3A] uppercase tracking-wider block border-b border-slate-100 pb-1.5">7. MEETING PERSONS</span>
                ...
                {/* Section 8: Siblings Info */}
                {psh?.siblings && psh.siblings.length > 0 && (
                  <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-2 text-xs">
                    <span className="text-[11px] font-bold text-[#0D5C3A] uppercase tracking-wider block border-b border-slate-100 pb-1.5">8. SIBLINGS INFO</span>
                    <table className="w-full text-left">
                      <thead>
                        <tr className="text-slate-400 border-b border-slate-100 text-[10px]">
                          <th className="py-1">Name</th>
                ...
                {/* Section 9: Witness Info */}
                {psh?.witnesses && psh.witnesses.length > 0 && (
                  <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-2 text-xs">
                    <span className="text-[11px] font-bold text-[#0D5C3A] uppercase tracking-wider block border-b border-slate-100 pb-1.5">9. WITNESS INFO</span>
                    <table className="w-full text-left">
                      <thead>
                        <tr className="text-slate-400 border-b border-slate-100 text-[10px]">
                ...
                {/* Section 10: Result Info */}
                {psh?.resultInfo && (
                  <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-2 text-xs">
                    <span className="text-[11px] font-bold text-[#0D5C3A] uppercase tracking-wider block border-b border-slate-100 pb-1.5">10. RESULT INFO</span>
                ...
                {/* Section 11 & 12: Health & Report */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-2 text-xs">
                    <span className="text-[11px] font-bold text-[#0D5C3A] uppercase tracking-wider block border-b border-slate-100 pb-1.5">11. HEALTH CARE</span>
                ...
                {/* Section 13: Area of Interest – Child */}
                <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-1 text-xs">
                  <span className="text-[11px] font-bold text-[#0D5C3A] uppercase tracking-wider block border-b border-slate-100 pb-1.5">13. AREA OF INTEREST – CHILD</span>
                  <p className="text-slate-800 font-medium pt-1">
                    {psh?.areaOfInterest || 'No specific interest recorded.'}
                  </p>
                </div>

                {/* Section 14: Attachments Summary */}
                <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-2 text-xs">
                  <span className="text-[11px] font-bold text-[#0D5C3A] uppercase tracking-wider block border-b border-slate-100 pb-1.5">14. ATTACHMENTS VERIFICATION</span>
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
